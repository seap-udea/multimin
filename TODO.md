...
- [ ] Create and test routines for execution time measurement.
- [ ] Decide whether to create an `Orbit` class or use an external package.
- [ ] Decide management of physical and numerical units and constants.
- [ ] Calculate orbital elements before 4 orbital periods using rebound.
